...
const char program_name_ffplay[] = "ffplay";
const int program_birth_year_ffplay = 2003;
...
int ffplay(int argc, char **argv)
{
    ...
    if (!display_disable) {
        ...
        window = SDL_CreateWindow(program_name_ffplay, SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, default_width, default_height, flags);
